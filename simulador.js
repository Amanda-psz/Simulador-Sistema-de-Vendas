...
//função para lançar venda do produto
...
function registarItemVenda() {
  ...
  for (var i = 0; i < produtos.length; i++) {
    if (produtoAdicionado == produtos[i].codigoProduto) {
      ...
      return; // Saiando da função após adicionar produto a lista de lançamentos para depois gerar a nota fiscal
    }
  }
  alert("Código do produto inválido.");
}

//função imprimir nota fiscal
